...
from isk_video_subscription.users.models import User
from isk_video_subscription.users.tests.factories import UserFactory
from isk_video_subscription.users.views import (
    UserRedirectView,
    UserUpdateView,
    user_detail_view,
)
